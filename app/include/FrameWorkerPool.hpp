...
// 1-slot FramePool -- the identical code path video will use with more of
// both, not a separate single-threaded mode kept around for comparison.
//
...
// each pop hands back. The calling thread (main, today) owns submission,
// progress display, and waiting for completion -- see Pipeline.cpp and
